...
def compare_designed_and_given(my_design, numpy_result):
    if my_design == numpy_result:
        print("The result of median filter designed by me is equal to the result of median funtion from numpy library")
        return True
    else:
        print("The result of median filter designed by me is not equal to the result of median funtion from numpy library")
        return False
